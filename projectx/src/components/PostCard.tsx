...
export function PostCard({ post, onEdit, onDelete, onSelect, onLike, onSave, canEdit, isLiked, isSaved }: PostCardProps) {
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg
                ...
                stroke="currentColor"
                strokeWidth="2"
                className={`${isSaved ? "text-blue-500" : "text-white/60"}`}
              >
